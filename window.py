...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.timelinePointTree = QtWidgets.QTreeWidget(self.centralwidget)
        ...
        self.stateJsonTextEdit = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.stateJsonTextEdit.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.stateJsonTextEdit.sizePolicy().hasHeightForWidth())
        self.stateJsonTextEdit.setSizePolicy(sizePolicy)
